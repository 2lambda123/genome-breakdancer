...
int main(int argc, char **argv) {
  try {
    ...
    ConfigBuilder cfg_builder(
        *out, dist_out.get(), params.bams, params.min_mapq,
        params.min_observations, params.num_devs, params.num_mads,
        params.no_progress_limit, params.skip, regions, params.verbose);
