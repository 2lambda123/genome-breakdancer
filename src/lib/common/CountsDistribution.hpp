...
template <typename T, typename Enable = void> class CountsDistribution;
...
public:
  ...
  template <typename... Types> void observe_many(Types... xs) {
    pass{(observe(xs), 1)...};
  }
